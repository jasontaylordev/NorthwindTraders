...
export class CategoriesClient {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(API_BASE_URL) baseUrl?: string) {
        this.http = http;
        this.baseUrl = baseUrl ? baseUrl : "https://localhost:44376";
    }

    getAll(): Observable<CategoryLookupModel[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CategoryLookupModel[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<CategoryLookupModel[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<CategoryLookupModel[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(CategoryLookupModel.fromJS(item));
            }
        ...
        return _observableOf<CategoryLookupModel[]>(<any>null);
    }
}
...
export class CategoryLookupModel implements ICategoryLookupModel {
    id?: number;
    name?: string | undefined;

    constructor(data?: ICategoryLookupModel) {
        if (data) {
    ...
    static fromJS(data: any): CategoryLookupModel {
        data = typeof data === 'object' ? data : {};
        let result = new CategoryLookupModel();
        result.init(data);
        return result;
    }
...
export interface ICategoryLookupModel {
    id?: number;
    name?: string | undefined;
}
